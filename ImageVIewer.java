package com.toniordning.imageviewer;
...
/**
 * A simple image viewer for opening, viewing and deleting images
 * that are stored in the users hard drive. Licensed under the MIT license,
 * this software will be available at https://github.com/ToniOrdning/ImageViewer
 * 
 * @author Toni Ordning
 * @version 1.0.0
 * @since 1.0.0
...
public class ImageViewer extends Application {
	...
	protected void chooseFile(ImageView viewer) { // Select files for viewing
		...
		/*
		 * Method for choosing images that the user wants to see or make a slideshow of.
		 */
	...
	protected void deleteImage() {
		...
		/*
		 * Deletes current image that is being shown.
		 */
	...
	protected void showNewImage() {
		...
		/*
		 * The method that shows images. Usually used with earlier methods.
		 */
	...
	protected void startSlideshow() {
		...
		/*
		 * Starts a standard slideshow with 5 second interval between switching images.
		 */
	...
	protected void startRandomSlideshow() {
		...
		/*
		 * Starts a randomized slideshow with 5 seconds between images.
		 */
	...
	protected void whenWindowSizeUpdate() {
		...
		/*
		 * Limits the images size so that it fits the size of the window.
		 */
